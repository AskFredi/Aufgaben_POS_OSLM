...
<div class="container">
    ...
    if(isset($_POST['submit'])){
        ...
        if(validate($name, $email, $examDate, $subject, $grade)){
            echo "<p class='alert alert-success'>Die eingegebenen Dateb sind in Ordnung!</p>";
        }else{
            echo "<p class='alert alert-danger'>Die eingegebenen Dateb sind fehlerhaft!</p><ul>";
    ...
    ?>
    <form id="from_grade" action="index.php" method="post">
        <div class="row">
                ...
                <div class="col-sm-4 form-group" >
                    ...
                    <input type="date"
                       ...
                       class="form-control <?= isset($errors['examDate']) ? 'is-invalid' : '' ?>"
                           ...
                           onchange="validdateExamDate(this)"
                           required="required"
                />
                </div>
